...
class Home extends React.Component {
  ...
  componentDidMount = () => {
    if (!this.props.isSignedIn || !this.props.currentUser) {
      ...
      new Image().src =
        "https://res.cloudinary.com/dwbg1zcql/image/upload/v1569513124/logo_q9j2rj.svg".fileName;
    ...
    if (this.state.individual) {
      ...
      return (
        <div className="d-flex flex-column" style={{ height: "100%" }}>
            ...
            <div className="d-flex flex-column visible">
              <div className="d-flex justify-content-between align-items-center mt-3">
                <i
                  ...
                  className="far fa-clock btn-icon-vent"
                ></i>
                <img
                  className="logo"
                  src="https://res.cloudinary.com/dwbg1zcql/image/upload/v1569513124/logo_q9j2rj.svg"
          ...
          {/* <PainList sortingType={this.state.sortingType} changeSorting={this.changeSorting} /> */}
          <PainList
            toggleIndividual={this.toggleIndividual}
            individual={this.state.individual}
            individual_id={this.state.individual_id}
          />
          <Button
            buttonStatus={0}
            buttonFunction={() => history.push("/add")}
          />
        </div>
      );
    }
