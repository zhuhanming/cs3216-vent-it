  ...
  render() {
    return (
      <div className="container landing">
        <div
          id="message"
          className="landing d-flex flex-column justify-content-center align-items-center visible invisible text-center"
        >
          <img
          ...
          <button className="btn btn-vent" onClick={() => this.resendEmail()}>
            <h6>
              Can't find the email? <br />
              Click here to resend the email.
            </h6>
          </button>
          <small onClick={() => this.props.signOut()} className="mt-1">
            {" "}
            Not your account? Click here to sign out{" "}
          </small>
          <br />
